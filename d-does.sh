...
echo $white"                  MENU                     "
echo $green"============================================="
echo $red"[1].DDOS ATTACK.   #•⊱•Iqubal420"
echo $red"[2].DoS ATTACK.    #01843933402"
echo $red"[3].BOTNET ATTACK. #•⊱•iqubal420"
echo $red"[4].EXIT TOOL.     #    Selamat Menggunakan"
echo $green"============================================="
echo $white "╭─"$yellow"•⊱•IQUBAL SARKAR"
read -p " ╰─> " pil
